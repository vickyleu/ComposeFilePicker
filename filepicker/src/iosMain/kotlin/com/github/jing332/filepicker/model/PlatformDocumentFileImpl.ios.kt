...
actual class PlatformDocumentFileImpl actual constructor(
    ...
    override fun inputStream(): InputStreamImpl {
        return InputStreamImpl(context.contentResolver.openInputStream(file.uri)!!)
    }

    override fun outputStream(): OutputStreamImpl {
        return OutputStreamImpl(context.contentResolver.openOutputStream(file.uri)!!)
    }
